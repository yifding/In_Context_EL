...
token='bghYx41XgZi5p7G9q0Kg59RsHEEwIZvWyJY4FUAas3hatwj_UN-YGvJbtj73X8YHWhKuJQ.'
...
def parse_args():
    ...
    parser.add_argument(
        ...
        # required=True,
        default='/nfs/yding4/In_Context_EL/RUN_FILES/4_13_2023/rel_blink/entity_candidate_prompt_bard',
        type=str,
    )
    parser.add_argument(
        "--output_file",
